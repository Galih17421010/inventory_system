                      ...
                      <Select class="form-control" id="supplier" name="supplier" required>
                        <option>-- Pilih Supplier --</option>
                            <?php
                              ...
                              ?>
                              <option <?php if($sup["kd_supplier"] == $row['kd_supplier']) { ?> selected="selected" <?php } ?> value="<?= $sup['kd_supplier'] ?>">
                          ...
                          $result = mysqli_query($koneksi, $sql);
                            ...
                            while($datas = mysqli_fetch_array($result)){?>    
                                <tr>
                                    ...
                                    <td><center><button type="button" class="btn btn-danger btn-xs remove" id="remove'+count+'">
    ...
    count = count + 1;
      $('#tableTransaksiMasuk').append('<tr id='+count+'>'+
                          '<td>'+
                            ...
                            '</select>'+
                          '</td>'+
                          '<td><input type="text" class="form-control harga_beli" name="harga_beli[]" id="harga_beli'+count+'"></td>'+
                          ...
                          '<td><input type="text" class="form-control harga_jual" name="harga_jual[]" id="harga_jual'+count+'"></td>'+
                          '<td><center>'+
